        ...
        <div class="container">
          <div class="row">
            <div class="col-md-3 text-left text-md-center mb-3">
              <img class="rounded-circle img-fluid" src="{{asset('image/ali.jpg')}}"  alt="Profile Photo" />
            </div>
            <div class="col-md-9">
              <h1>Ali Raza</h1>
        ...
        <div class="container">
         <div class="row p-3">
           <div class="col-md pb-2 pb-md-0">
              ...
              <a href="#" class="text-white ml-2">aliraza@gmail.com</a>
           </div>
           <div class="col-md text-md-center pb-2 pb-md-0">
              ...
              <a href="#" class="text-white ml-2">www.mywebsite.com</a>
            </div>       
            <div class="col-md text-md-right">
              ...
              <a href="#" class="text-white ml-2">+92 300 4925644</a>
            </div>       
          </div>
        </div>
      </nav>
...
<div class="row">
  <div class="col-md mb-3">
    <a href="#">
      <img class="img-fluid img-thumbnail" src="{{asset('image/BMIs.png')}}">
    </a>
  </div> 
  <div class="col-md mb-3">
    <a href="#">
      <img class="img-fluid img-thumbnail" src="{{asset('image/untitled-5.png')}}">
    </a>
  </div> 
</div>
<div class="row">
  <div class="col-md mb-3">
    <a href="#">
      <img class="img-fluid img-thumbnail" src="{{asset('image/bmi.png')}}">
    </a>
  </div> 
  <div class="col-md mb-3">
    <a href="#">
 ...
 <footer class="bg-dark text-white-50 text-center mt-5 p-3">
  &copy; 2021  Ali Raza - <a href="#" class="text-white-50">GitHub</a> | <a href="#" class="text-white-50">LinkedIn</a> | <a href="#" class="text-white-50">Twitter</a>
</footer>



    {{-- link for javascript and bootstrap popin --}}
